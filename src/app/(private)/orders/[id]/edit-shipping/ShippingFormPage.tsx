...
const ShippingFormPage = ({
  ...
  const fetchShippingMethods = async () => {
    try {
      const data = await getFunction<ShippingMethod[]>(GET_SHIPPING_METHODS_URI, true, user as User);
      if (data) {
  ...
  const fetchShippingWarranties = async () => {
    try {
      const data = await getFunction<ShippingWarranty[]>(GET_SHIPPING_WARRANTIES_URI, true, user as User);
      if (data) {
