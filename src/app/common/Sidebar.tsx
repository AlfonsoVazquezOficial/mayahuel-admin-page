...
const Sidebar = () => {
  ...
  return (
    <>
      ...
      {/* Mobile overlay */}
      {isMobile && isOpen && (
        <div className="fixed inset-0 dark:bg-gray-900 bg-gray-500 opacity-50 z-40 lg:hidden" onClick={() => setIsOpen(false)} />
      )}
      ...
      >
        ...
        <div className="flex-shrink-0 p-5 border-b dark:border-gray-500 border-gray-200">
          ...
          {isOpen && (
            <div>
              <h1 className="text-center text-xl font-bold"><span className="dark:text-gray-200 text-gray-500">Eth</span><span className="text-yellow-500">os</span></h1>
            </div>
          )}
        </div>
